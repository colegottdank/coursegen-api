...
export const assistant1 = `{"success": true, "data": {"course": {"title": "A Beginner's Guide to World History", "dates": "", "description": "This course provides a comprehensive introduction to World History, aimed at beginners with little to no prior knowledge.", "sections": [{"title": "Pre-Colonial History", "dates": "Before 1500 CE", "description": "This section covers the early history of human civilization, from the first humans and their migration patterns to the development of early civilizations around the world."}]}}}`

export const user1error = `Ben Frkl1n, 1 section, I have no knowledge of Ben Frkl1n`

export const assistant1error = `{"success":false,"data":{},"error":{"message":"I'm sorry, but I'm not familiar with the subject "Ben Frkl1n". Did you mean "Benjamin Franklin"? Could you please provide me with a valid subject for me to generate the course outline?"}}`
...
- Error handling: If the user provides an invalid subject or there is uncertainty in what the user requested, return appropriate error message

Success Example:
User Input: World History, 1 section, I have no knowledge of world history
Assistant Response: {"success": true, "data": {"course": {"title": "A Beginner's Guide to World History","sections": [{"title": "Pre-Colonial History", "dates": "Before 1500 CE", "description": "This section covers the early history of human civilization, from the first humans and their migration patterns to the development of early civilizations around the world."}]}}}

Error Example:
User Inputs invalid subject: Ben Frkl1n, 1 section, I have no knowledge of Ben Frkl1n
Assistant Response: {"success":false,"data":{},"error":{"message":"I'm sorry, but I'm not familiar with the subject "Ben Frkl1n". Did you mean "Benjamin Franklin"? Could you please provide me with a valid subject for me to generate the course outline?"}}`